                ...
                if (password == "" && pasiIndex){
                    if (newPassword == writePass) {
                        ...
                        Handler(Looper.getMainLooper()).postDelayed({
                            ...
                            startActivity(Intent(this, BankPage::class.java))
                            finish()
                        }, 500)
                    } else {
                        click = false
                        ...
                        Handler(Looper.getMainLooper()).postDelayed({
                            click = true
                            viewLog_one?.setBackgroundResource(R.drawable.corner)
                            viewLog_two?.setBackgroundResource(R.drawable.corner)
                            viewLog_three?.setBackgroundResource(R.drawable.corner)
                            viewLog_four?.setBackgroundResource(R.drawable.corner)
